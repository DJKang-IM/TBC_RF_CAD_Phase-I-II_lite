"""Load all models and run end-to-end inference (tbc-cad-ver.1.03)."""
...
from tbc_cad_ver_103.config import IntegratedCadConfig
from tbc_cad_ver_103.dicom_featurizer import DicomFeaturizer
from tbc_cad_ver_103.hybrid_phase3 import D6_INDEX, LABEL_KEYS, Phase3HybridD6XGB, register_pickle_aliases
...
class IntegratedCad:
    """
    **tbc-cad-ver.1.03** — DICOM in; Phase I / II / III with D1 through D6 (D5 cavitary + D6 XGB).
    """

    model_line = "tbc-cad-ver.1.03"
    ...
    def predict(self, dicom_path: str | Path) -> InferenceResult:
        ...
        for j, key in enumerate(LABEL_KEYS):
            ...
            if rf_row is not None and j < len(rf_row):
