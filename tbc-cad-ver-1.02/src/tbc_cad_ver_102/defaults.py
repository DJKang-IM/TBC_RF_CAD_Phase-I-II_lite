"""Convention-based search for Phase III + D6 artifacts (no CLI flags needed on typical installs)."""
...
def default_hybrid_candidates(phase3_root: Path) -> list[Path]:
    ...
    return [
        root / "artifacts" / "phase3_v1_02_d6_xgb" / "phase3_rf_v1_02_d6_xgb_hybrid.joblib",
        root / "phase3_rf_v1_02_d6_xgb_hybrid.joblib",
    ]
